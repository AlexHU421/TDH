CREATE  TABLE `T_STG_TDH_HARDWARE_LOAD_INFO`(
...
LOCATION
  'hdfs://nameservice1/inceptor8/user/hive/warehouse/stg.db/stg/stg.t_stg_tdh_hardware_load_info@hyperdrive.stargate'
TBLPROPERTIES (
  'transient_lastDdlTime'='1629947229', 
  'hbase.table.name'='T_STG_TDH_HARDWARE_LOAD_INFO', 
