CREATE  TABLE `T_STG_TDH_HARDWARE_CPU_INFO`(
...
LOCATION
  'hdfs://nameservice1/inceptor8/user/hive/warehouse/stg.db/stg/stg.t_stg_tdh_hardware_cpu_info@hyperdrive.stargate'
TBLPROPERTIES (
  'transient_lastDdlTime'='1629947219', 
  'hbase.table.name'='T_STG_TDH_HARDWARE_CPU_INFO', 
